...
(function (namespace) {
                ...
                var es = {
                    ...
                    "workExperience": {
                        ...
                        "items": [{
                            ...
                            "period": "Junio de 2017 – Marzo de 2020",
                            "observation":"Desarrollador Senior en TAMSA (TENARIS), participando en proyectos en plataforma .net en lenguaje C# y HTML5 Javascript,  dentro de los mas destacados: \
                    ...
                    "certification": {
                        ...
                        "items": [{
                            "logo": "SDPC.png",
                            "title": "<b>Scrum Developer Professional Certificate (SDPC)</b>",
            ...
            Recuperar: function () {
                ...
                if (data !== null) {
                    ...
                    for (var i = 0; i < fields.length; i++) {
                        var field = fields[i];
                        if (typeof self.Jarvis.AutoGuardadoFields[field.id] !== "undefined") {
                    ...
                    for (var r = 1; r < table.rows.length; r++) {
                        ...
                        for (var i = 0; i < terms.length; i++) {
                            ...
                            .indexOf(terms[i]) < 0) {
                                ...
                                if (terms[i].length)
                                    this.Resaltar(terms[i], table.rows[r]);
                                finded = true;
                            }
    ...
    *----------------------------*/
    try {
        ...
        Object.defineProperty(Jarvis.prototype, "AutoGuardadoFields", {
            get: function AutoGuardadoFields() {
                if (_Info) {
                    console.log('info: "AutoGuardadoFields", crea una instancia de cada objet de tipo Text, Select, TextArea, y almacena su valor');
                }
                var fields = __("input[autoguardado],textarea[autoguardado],select[autoguardado]");
                for (var i = 0; i < fields.length; i++) {
                    var field = fields[i];
        ...
        * ------------------------------------------------------------------- */
        HTMLCollection.prototype.ToArray = function () {
            ...
            if (_Info) {
                console.log('info: "HTMLCollection.ToArray()", retorna un Array, a partir de un HTMLCollection');
            }
            var arr = [];
        ...
        NodeList.prototype.ToArray = function () {
            ...
            if (_Info) {
                console.log('info: "NodeList.ToArray()", retorna un Array, a partir de un NodeList');
            }
            var arr = [];
            for (var i = this.length - 1; i >= 0; i--) {
                arr.push(this[i]);
        ...
        Array.prototype.Distinct = function (column, value) {
            ...
            if (_Info) {
                console.log('info: "Array.Distinct(column,value)", retorna un arreglo de string con los nombre unicos del arreglo');
            }
    ...
    *--------------------------------------------*/
    ...
    if (typeof namespace.console === "undefined") {
        if (_Tracert) {
            console.log('metodo: "namespace.console.log(msj)", ha cargado exitosamente');
        }
        if (_Info) {
    ...
    if (typeof namespace.getElementsByClassName === "undefined") {
        if (_Tracert) {
            console.log('metodo: "document.getElementsByClassName(cl)", ha cargado exitosamente');
        }
        if (_Info) {
    ...
    if (typeof namespace._ === "undefined") {
        if (_Tracert) {
            console.log('metodo: "namespace._(id)", ha cargado exitosamente');
        }
        if (_Info) {
